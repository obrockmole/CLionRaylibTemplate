...
void DrawTextCentered(const char *text, Vector2 position, float fontSize, Color tint) {
...
void DrawTextCenteredEx(Font font, const char *text, Vector2 position, float fontSize, float spacing, Color tint) {
...
void DrawTextCenteredPro(Font font, const char *text, Vector2 position, Vector2 origin, float rotation, float fontSize, float spacing, Color tint) {
    Vector2 textSize = MeasureTextEx(font, text, fontSize, spacing);
    Vector2 drawPosition = {position.x - textSize.x / 2, position.y - textSize.y / 2};
